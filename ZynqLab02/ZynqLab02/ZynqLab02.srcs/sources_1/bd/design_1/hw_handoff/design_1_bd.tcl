...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set BTNSW [ create_bd_port -dir I -from 3 -to 0 -type data BTNSW ]
  set LED [ create_bd_port -dir O -from 3 -to 0 -type data LED ]
  set RGB [ create_bd_port -dir O -from 5 -to 0 -type data RGB ]
  set SLDSW [ create_bd_port -dir I -from 3 -to 0 -type data SLDSW ]

  # Create instance: mySimpleIO_0, and set properties
  set mySimpleIO_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:mySimpleIO:1.0 mySimpleIO_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins mySimpleIO_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net BTNSW_1 [get_bd_ports BTNSW] [get_bd_pins mySimpleIO_0/iBtnSW]
  connect_bd_net -net SLDSW_1 [get_bd_ports SLDSW] [get_bd_pins mySimpleIO_0/iSldSW]
  connect_bd_net -net mySimpleIO_0_oLED [get_bd_ports LED] [get_bd_pins mySimpleIO_0/oLED]
  connect_bd_net -net mySimpleIO_0_oRGB [get_bd_ports RGB] [get_bd_pins mySimpleIO_0/oRGB]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins mySimpleIO_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins mySimpleIO_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mySimpleIO_0/S00_AXI/S00_AXI_reg] SEG_mySimpleIO_0_S00_AXI_reg
