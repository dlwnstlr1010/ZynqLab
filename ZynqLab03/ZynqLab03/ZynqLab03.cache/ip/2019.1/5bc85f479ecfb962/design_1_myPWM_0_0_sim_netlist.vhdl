...
\rDuty[11]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\rDuty[11]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\rDuty[11]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000000000000000"
    )
        port map (
...
rPWM_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
myPWM_v1_0_S00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_myPWM_v1_0_S00_AXI
     port map (
      Q(11 downto 0) => slv_reg0(11 downto 0),
      clear => clear,
...
pwm: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PWM
     port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^opwm\ : STD_LOGIC_VECTOR ( 0 to 0 );
